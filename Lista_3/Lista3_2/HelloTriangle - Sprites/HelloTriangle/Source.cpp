...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Lista 3 - Exercicio 2! -- Guilherme Maia Nogueira", nullptr, nullptr);
	...
	spr.inicializar(texID, glm::vec3(400.0, 300.0, 0.0), glm::vec3(50, 100, 1.0),0);
