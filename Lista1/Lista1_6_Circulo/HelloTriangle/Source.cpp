...
int main()
{
	...
	int nVertices = nPoints+2;//Código para exercício 6 - Círculo, Octágono, Pentágono, Pizza   
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glDrawArrays(GL_TRIANGLE_FAN, 0, nVertices);//Código para Círculo, Octágono, Pentágono, Pac-man
...
int createCircle(int nPoints, float radius)
{
	...
	for (int i = 0;i < nPoints +1; i++) { //Código para exercício 6 - Círculo, Octágono, Pentágono, Fatia de Pizza  
	//for (int i = 0;i < nPoints-2; i++) { //Código para exercício 6 - c) Pac-man 
