...
stickers_map = {
    ord('a'): cv2.imread('GatoBranco.png', cv2.IMREAD_UNCHANGED),
    ord('g'): cv2.imread('Pele.png', cv2.IMREAD_UNCHANGED),
    ord('i'): cv2.imread('BuzzLightyear.png', cv2.IMREAD_UNCHANGED),
    ord('k'): cv2.imread('DogDeOculos.png', cv2.IMREAD_UNCHANGED),
    ord('o'): cv2.imread('Ozzy.png', cv2.IMREAD_UNCHANGED),
    ord('p'): cv2.imread('DoNeida.png', cv2.IMREAD_UNCHANGED),
    ord('u'): cv2.imread('CalmaiPaizao.png', cv2.IMREAD_UNCHANGED),
    ord('z'): cv2.imread('GatoPreto.png', cv2.IMREAD_UNCHANGED),
    ord('y'): cv2.imread('MeninaCopo.png', cv2.IMREAD_UNCHANGED),
    ord('w'): cv2.imread('Picapau.png', cv2.IMREAD_UNCHANGED),
}
...
def display_instructions():
    ...
    print("q: Salvar")
    print("===============================")
    print("a: Adicionar sticker GatoBranco")
    print("g: Adicionar sticker Pele")
    print("i: Adicionar sticker BuzzLightyear")
    print("k: Adicionar sticker DogDeOculos")
    print("o: Adicionar sticker Ozzy")
    print("p: Adicionar sticker DoNeida")
    print("u: Adicionar sticker CalmaiPaizao")
    print("z: Adicionar sticker GatoPreto")
    print("y: Adicionar sticker MeninaCopo")
    print("w: Adicionar sticker Picapau")
    print("===============================")
...
def edit_image(image_path):
    ...
    while True:
        ...
        if salvar == 1: 
            cv2.imwrite(f'./photos/imagem_editada{count}.jpg', frame_filtered)
...
def edit_webcam():
    ...
    while True:
        ...
        if salvar == 1: 
            cv2.imwrite(f'./photos/webcam_editada{count}.jpg', frame_filtered)
